                    ...
                    <Card key={order.id}>
                        <CardContent className="p-4">
                            ...
                            <div className="text-sm text-gray-600 mb-3">
                                <p><strong>Customer:</strong> {order.guest_name || order.customer_name || 'Guest'}</p>
                                <p><strong>Contact:</strong> {order.phone} {order.guest_email || order.customer_email ? `• ${order.guest_email || order.customer_email}` : ''}</p>
