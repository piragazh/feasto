...
export const DESIGN_TEMPLATES = [
    ...
    },
    {
        ...
        config: {
            ...
            button_style: 'sharp',
            button_text_color: '#ffffff',
            add_to_cart_color: '#292524',
            heading_color: '#292524',
            font_style: 'elegant',
    ...
    },
    {
        ...
        config: {
            ...
            button_style: 'pill',
            button_text_color: '#ffffff',
            add_to_cart_color: '#7c3aed',
            heading_color: '#ddd6fe',
            font_style: 'classic',
