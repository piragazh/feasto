...
const SystemOverview = () => <div>SystemOverview loading...</div>;
const RestaurantManagement = () => <div>RestaurantManagement loading...</div>;
const MessagingCenter = () => <div>MessagingCenter loading...</div>;
const CommissionManagement = () => <div>CommissionManagement loading...</div>;
const SystemMonitoring = () => <div>SystemMonitoring loading...</div>;
const CuisineTypeManagement = () => <div>CuisineTypeManagement loading...</div>;
const DomainManagement = () => <div>DomainManagement loading...</div>;
const EnhancedAnalytics = () => <div>EnhancedAnalytics loading...</div>;
const EnhancedDriverManagement = () => <div>EnhancedDriverManagement loading...</div>;
const PlatformRefundOversight = () => <div>PlatformRefundOversight loading...</div>;
const PayoutManagement = () => <div>PayoutManagement loading...</div>;
const PayoutHistory = () => <div>PayoutHistory loading...</div>;
const OrderHistoryManagement = () => <div>OrderHistoryManagement loading...</div>;
const ReviewModerationSuper = () => <div>ReviewModeration loading...</div>;
const PromotionOversight = () => <div>PromotionOversight loading...</div>;
const LoyaltyProgramSettings = () => <div>LoyaltyProgramSettings loading...</div>;
const TierBenefitsManagement = () => <div>TierBenefitsManagement loading...</div>;
const PublicFilesManagement = () => <div>PublicFilesManagement loading...</div>;
const GlobalScreenHealthMonitor = () => <div>GlobalScreenHealthMonitor loading...</div>;
const SmsLogViewer = () => <div>SmsLogViewer loading...</div>;
const BulkPriceAdjustment = () => <div>BulkPriceAdjustment loading...</div>;
const BackupRestore = () => <div>BackupRestore loading...</div>;
const OfflineReviewPortfolio = () => <div>OfflineReviewPortfolio loading...</div>;
const ManagerOperatorAnalytics = () => <div>ManagerOperatorAnalytics loading...</div>;
const OfflineTemporalAnalytics = () => <div>OfflineTemporalAnalytics loading...</div>;
const OperatorAnalytics = () => <div>OperatorAnalytics loading...</div>;
const ShiftWindowAnalytics = () => <div>ShiftWindowAnalytics loading...</div>;
const OfflineRiskDigest = () => <div>OfflineRiskDigest loading...</div>;
